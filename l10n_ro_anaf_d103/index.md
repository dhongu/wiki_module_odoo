...
- **Versiune:** `19.0.1.0.0`
- **Cale:** [https://github.com/terrabit-solutions/l10n_ro_ent/tree/19.0/l10n_ro_anaf_d103](https://github.com/terrabit-solutions/l10n_ro_ent/tree/19.0/l10n_ro_anaf_d103)
...
- **Izolare față de D120**: exportul D103 folosește propriul template XML; decontul anual D120 este tratat de modulul-soră [l10n_ro_anaf_d120](../l10n_ro_anaf_d120/index.md), peste aceeași infrastructură [l10n_ro_excise_duty](../l10n_ro_excise_duty/index.md).
...
- `l10n.ro.excise.declaration` (extins): adaugă metoda `_export_d103_xml()`, hook apelat de dispatcher-ul `export_to_xml` din `l10n_ro_excise_duty` pentru declarațiile de tip `d103`. Construiește antetul (CUI, denumire companie, lună, an) și liniile (categorie, cantitate, U.M., acciză) din `line_ids`, randează template-ul QWeb XML, generează numele fișierului `D103_<CUI>_<AAAALL>.xml` și trece declarația din starea `confirmed` în `exported`.

**Vizualizări**

Nu adaugă vizualizări proprii; folosește formularul declarației de accize definit în `l10n_ro_excise_duty`, unde butonul „Export XML" declanșează generarea specifică D103.
...
- [l10n_ro_excise_duty](../l10n_ro_excise_duty/index.md): furnizează modelul `l10n.ro.excise.declaration`, categoriile de produse accizabile și dispatcher-ul `export_to_xml` extins de acest modul.
