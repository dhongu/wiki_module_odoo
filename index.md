...
- [deltatech_marketplace_emag](deltatech_marketplace_emag/index.md): Conector eMAG Marketplace — produse, stocuri (în loturi de 50), comenzi, plăți, vouchere și importul retururilor (RMA, doar citire); AWB-urile s-au mutat în `deltatech_marketplace_emag_delivery`.
...
- [deltatech_marketplace_shopify](deltatech_marketplace_shopify/index.md): Conector Odoo–Shopify (GraphQL) — produse, clienți, comenzi cu anulare în ambele sensuri, export opțional al liniilor de comandă, importul retururilor (doar citire) și wizard de verificare a webhook-urilor.
