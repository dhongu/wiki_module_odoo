...
- **Rezerva 105 afișată pe activ** (`l10n_ro_revaluation_reserve`) se calculează acum din soldul REAL al liniilor contului 105 din notele de reevaluare postate (fix 19.0.1.3.4), nu din suma algebrică a tuturor reevaluărilor — anterior putea arăta o valoare falsă (ex. -2.000 deși 105 nu fusese atins deloc, dacă o diminuare depășise soldul și mersese integral pe 655) și permitea unei a doua diminuări succesive să consume din 105 mai mult decât soldul real rămas. O creștere care compensează o diminuare anterioară recunoscută pe 655 trece acum întâi prin cont nou **755** „Venituri din reevaluare" (OMFP 1802/2014 pct. 111 alin. (1), liniuța a doua), abia restul intrând în 105. Câmp nou `l10n_ro_revaluation_reserve_transferred` (fix 19.0.1.3.5) — după transferul 105→1175 la casare, rezerva afișată arată corect 0 (nu mai vechea valoare), și transferul nu se mai poate dubla.
- **Cost istoric de achiziție resincronizat în ciornă** (fix 19.0.1.3.5): `l10n_ro_acquisition_value` (pragul minim al bazei fiscale) se resincronizează la orice corectare a valorii activului cât e încă în ciornă (ex. Pasul 1 — activ generat automat la factură, completat manual) — anterior rămânea la valoarea inițială, posibil greșită, fără nicio eroare vizibilă. După validare rămâne înghețat. Vânzarea fără `loss_account_id` configurat ridică acum un `UserError` explicit, în loc să lase nota de cedare dezechilibrată.
