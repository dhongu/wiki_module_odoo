...
- [deltatech_delivery_review](deltatech_delivery_review/index.md): Aliniază rambursul judecat de verificarea comenzilor cu suma reală de pe AWB și afișează motivul reținerii în dialogurile „Trimite la curier” și „Validare livrări”.
...
- [deltatech_marketplace_emag](deltatech_marketplace_emag/index.md): Conector eMAG Marketplace — produse, stocuri (în loturi de 50), comenzi, plăți, vouchere, importul retururilor (RMA, doar citire) și al rambursărilor; AWB-urile s-au mutat în `deltatech_marketplace_emag_delivery`.
...
- [deltatech_marketplace_extended](deltatech_marketplace_extended/index.md): Conector Odoo pentru platforma Extended.ro (produse, comenzi, stoc, categorii), cu API V2 opțional, webhook-uri semnate și mesaj de termen de livrare calculat automat.
...
- [deltatech_marketplace_review](deltatech_marketplace_review/index.md): Motive de verificare pentru comenzile importate din marketplace (mesaj client, ramburs peste limita backendului, total diferit, locker lipsă), cu reluarea confirmării automate la 5 minute.
...
- [deltatech_marketplace_shopify](deltatech_marketplace_shopify/index.md): Conector Odoo–Shopify (GraphQL) — produse, clienți, comenzi cu anulare în ambele sensuri, export opțional al liniilor de comandă, importul retururilor și al rambursărilor (doar citire) și wizard de verificare a webhook-urilor.
...
- [deltatech_purchase_create_bill_button](deltatech_purchase_create_bill_button/index.md): Restaurează butonul „Create Bill" cu un singur clic (evidențiat vizual) și copierea referinței furnizorului pe factura generată din comanda de achiziție, eliminate în Odoo 19.
...
- [l10n_ro_partner_ledger_currency](l10n_ro_partner_ledger_currency/index.md): Extinde Partner Ledger cu coloane Debit/Credit/Sold în valuta originală, grupare pe valută, confirmare de sold și fișă de cont în valută pentru companiile românești cu parteneri externi.
...
- [l10n_ro_partner_ubo](l10n_ro_partner_ubo/index.md): Evidența beneficiarilor reali (UBO) ai partenerilor persoane juridice, cu screening AML pe persoane conform Legii 129/2019.
...
- [l10n_ro_period_close_enhanced](l10n_ro_period_close_enhanced/index.md): Checklist lunar de închidere de perioadă pe infrastructura Enterprise account.return.type, cu 20 de verificări — confruntări de solduri, depuneri ANAF cu recipisă și controale operaționale de stoc.
...
- [l10n_ro_pos_fiscal_compliance_ecr](l10n_ro_pos_fiscal_compliance_ecr/index.md): Punte care traduce răspunsul driverului casei de marcat (Terrabit Connect) în starea fiscală AMEF urmărită de l10n_ro_pos_fiscal_compliance.
...
- [l10n_ro_stock_gestiune](l10n_ro_stock_gestiune/index.md): Gestiuni contabile de stoc (OMFP 2861/2009): gestionar, conturi pe gestiune, transfer valoric prin 481, recepție fără factură 371=408 cu stingere fără reconciliere — cu limitări documentate (cont gestiune doar la transfer, balanța fără transferuri interne, 408 nereevaluat lunar).
...
- [l10n_ro_stock_sheet_gestiune](l10n_ro_stock_sheet_gestiune/index.md): Punte între fișa de magazie/balanța stocurilor și gestiunile contabile de stoc — filtrare a raportului pe gestiuni, cu instalare automată.
