...
- `l10n_ro_intrastat`: modulul de bază al declarației Intrastat pe România, pe care acest modul îl extinde cu exportul XML, verificarea de erori, banner-ul de prag și logica de reconciliere.
